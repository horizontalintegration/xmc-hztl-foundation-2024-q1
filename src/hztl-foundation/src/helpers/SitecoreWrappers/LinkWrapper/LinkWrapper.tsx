...
const LinkWrapper = forwardRef<HTMLAnchorElement>(
  (
    {
      children,
      className,
    ...
    const { anchor, querystring, target, text, title } = field?.value as LinkFieldValue;

    let { href } = field?.value as LinkFieldValue;
