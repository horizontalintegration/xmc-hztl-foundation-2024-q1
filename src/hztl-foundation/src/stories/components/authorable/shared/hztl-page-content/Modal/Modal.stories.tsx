  ...
  parameters: {
    docs: {
      description: {
        component: `
## Overview
The modal component uses a JSS Placeholder to define its content, and listens for changes to the URL hash and a specific hash value to trigger the modal to open. In editing mode, the modal's content will be presented inline, and the URL hash value will be presented to the content author.
